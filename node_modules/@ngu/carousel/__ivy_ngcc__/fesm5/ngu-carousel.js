...
var NguCarousel = /** @class */ (function (_super) {
    ...
    NguCarousel.prototype._touch = function () {
        ...
        if (this.inputs.touch) {
            ...
            hammertime.get('pan').set({ direction: DIRECTION_HORIZONTAL });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NguCarouselModule, { declarations: function () { return [NguCarousel,
        ...
        NguCarouselOutlet]; }, imports: function () { return [CommonModule,
        HammerModule]; }, exports: function () { return [NguCarousel,
        NguItemComponent,
        NguTileComponent,
        NguCarouselPointDirective,
        NguCarouselItemDirective,
